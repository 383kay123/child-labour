...
class CommunityAssessmentModel {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      "primarySchoolsCount": primarySchoolsCount,
      "schoolsWithToilets": schoolsWithToilets,
      "schoolsWithFood": schoolsWithFood,
      "schoolsNoCorporalPunishment": schoolsNoCorporalPunishment,
      "rawData": rawData,
